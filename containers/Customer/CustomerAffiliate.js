...
class CustomerAffiliate extends React.Component {
    ...
    getRequestParams = () => {
        ...
        if (Id) {
            params = `${this.addParamsSeparator(params)}customerId=${Id}`
        }
...
export default connect(mapStateToProps)(CustomerAffiliate)
...
import { ReorderProduct } from '../../services/ProductService';
import HeaderSubmitButton from '../../components/HeaderSubmitButton';
class ProductReorder extends React.Component {
    ...
    submit = () => {
        ...
        ReorderProduct(this.state.data.length ? this.state.data.map(item => item.Id) : [], () => {
            this.lockSubmit = false
                        ...
                        <View
                            ...
                            <CustomTouchable
                                onPress={() => {
                                    ...
                                    }, 'Products/Simple', null, true, 2, this.state.data)
                                }}
                                style={{
                                    flexDirection: 'row',
                                    justifyContent: 'center',
